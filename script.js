...
const BIRTHDAY = '2026-08-29T00:00:00'
...
function updateCountdown() {
    ...
    if (diff <= 0 && diff > -86400000 && !flipped) {
        ...
        document.querySelector('.date').textContent = 'HAPPY BIRTHDAY MRS MICHELLE!'
        startConfetti()
        autoPlayMusic()
        document.title = '🎂 HAPPY BIRTHDAY MRS MICHELLE 🎂'
        return
    }
    ...
    if (diff <= -86400000) {
        ...
        document.getElementById('countdown').innerHTML = `<h2 style="font-size:2rem">MRS MICHELLE TURNED 18<br>${daysAgo} DAYS AGO 💀</h2>`
        document.querySelector('.date').textContent = 'THANKS FOR THE WISHES!'
        document.title = 'MRS MICHELLE TURNED 18 💀'
        return
    }
...
function shareWhatsApp() {
    ...
    const text = `🎂💀 MRS MICHELLE  TURNS ${age} 💀🎂%0A%0AAugust 29th 2026%0A%0ACheck out his birthday site:%0A${url}%0A%0ADrop a wish for the GOAT 🔥`
